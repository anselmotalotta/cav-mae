...
# python create_dataset_json.py --label_csv_file /storage/data/cavmae/audioset/eval_segment_labels.csv --video_folder /storage/data/cavmae/audioset/preprocesses/eval_segments/video_frames --audio_folder /storage/data/cavmae/audioset/preprocesses/eval_segments/sample_audio --output /storage/data/cavmae/audioset/audioset_eval_custom.json
